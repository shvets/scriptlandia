 ...
 */
public final class AptJellyStarter {
  ...
  public void start(final String[] args, ClassRealm mainRealm) throws Exception {
    ...
    String factoryClassName = "net.sf.jelly.apt.APTJellyProcessorFactory";
    ...
    javaTask.setTaskName("apt-jelly");
    ...
    arg2.setLine("-AjellyScript=" + scriptName);
  ...
  public static void main(String[] args, ClassWorld classWorld) throws Throwable {
    new AptJellyStarter().start(args, classWorld.getRealm("pom-launcher-apt-jelly"));
  }
