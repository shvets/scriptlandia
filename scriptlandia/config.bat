...
SET SYSTEM_PROPERTIES=%SYSTEM_PROPERTIES% -Dmaven.version=%MAVEN_VERSION%
...
SET SYSTEM_PROPERTIES=%SYSTEM_PROPERTIES% -Dfortress.version=%FORTRESS_VERSION%
