...
rem if "%PROXY_SERVER_HOST_NAME%" == "" (
rem   SET PROXY_SERVER_HOST_NAME=
rem )

rem if "%PROXY_SERVER_PORT%" == "" (
rem   SET PROXY_SERVER_PORT=
rem )
...
rem SET SYSTEM_PROPERTIES=%SYSTEM_PROPERTIES% %PROXY_PARAMS%
