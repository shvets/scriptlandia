...
if [ -f "../../../jlaunchpad/trunk/launcher/user/config.sh" ]; then
  . ../../../jlaunchpad/trunk/launcher/user/config.sh
fi
...
export JAVA_SPECIFICATION_VERSION_LEVEL ANT_VERSION BEANSHELL_VERSION SCRIPTLANDIA_VERSION
