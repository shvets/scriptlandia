...
SET JAVA_OPTS=-Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,address=5005,suspend=n,server=y -DIRIS_USER_DIR=C:\AppServers\jboss-4.2.0.GA\server\default
...
:RESTART
start %JAVA% %JAVA_OPTS% "-Djava.endorsed.dirs=%JBOSS_ENDORSED_DIRS%" -classpath "%JBOSS_CLASSPATH%" org.jboss.Main %*
