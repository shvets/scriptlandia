    ...
    extends AbstractScriptedMojoDescriptorExtractor
{
        ...
        throws InvalidPluginDescriptorException
    {
        ...
        try
        {
            ...
            JRubyInvoker invoker = new JRubyBSFInvoker( null );
            invoker.addReqLib( "/inline_extractor.rb" );
            invoker.setReader( new InputStreamReader( extractor ) );
            ...
            //RubyMojo mojo = new DefaultRubyMojo( invoker );
            //mojo.set( "reader", new InputStreamReader( extractor ) );

            //mojo.execute();

            //Map map = (Map)((DefaultRubyMojo)mojo).getReturned();
            ...
            {
        		Map executesMap = ((RubyHash)executes).getValueMap();
            ...
            if ( fields != null && !fields.isNil() )
            {
                ...
                for ( Iterator iter = fieldsList.iterator(); iter.hasNext(); )
                {
                    ...
                    setParameter( runtime, field.getValueMap(), mojoDescriptor );
                }
            }
        }
        catch ( Exception e )
    ...
    private String getParameter( IRuby runtime, Map params, String annotation )
    {
    ...
    private void setParameter( IRuby runtime, Map field, MojoDescriptor mojoDescriptor )
