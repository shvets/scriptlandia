...
/**
 * The handler for textbox control element when the user double clicks the mouse.
 */
...
/**
 * Sets the flag whether to dislay full list when: textbox is empty and
 * the user double cliks the mouse.
 */
