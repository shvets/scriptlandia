...
public class ExecuteWatchdog implements TimeoutObserver {
     ...
     * @throws  ForkerException   a wrapped exception over the one that was
     * silently swallowed and stored during the process run.
     */
    public synchronized void checkException() throws ForkerException {
        if (caught != null) {
            throw new ForkerException ("Exception in ExecuteWatchdog.run: "
