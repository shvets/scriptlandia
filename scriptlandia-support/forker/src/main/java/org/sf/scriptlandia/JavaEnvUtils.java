...
public final class JavaEnvUtils {
    ...
    private static final boolean IS_DOS = OsUtils.isFamily("dos");
    /** Are we on Novell NetWare */
    private static final boolean IS_NETWARE = OsUtils.isName("netware");
    /** Are we on AIX */
    private static final boolean IS_AIX = OsUtils.isName("aix");
