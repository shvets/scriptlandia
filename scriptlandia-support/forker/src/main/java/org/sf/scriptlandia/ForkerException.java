 ...
 */
public class ForkerException extends RuntimeException {
  ...
  private String location;
     ...
     */
    public ForkerException(String message) {
        super(message);
    }
     ...
     */
    public ForkerException(String message, Throwable cause) {
        super(message);
        this.cause = cause;
    }
     ...
     */
   public ForkerException(String msg, Throwable cause, String location) {
        this(msg, cause);
     ...
     *              Should not be <code>null</code>.
     */
    public ForkerException(Throwable cause) {
     ...
     *                 occurred. Must not be <code>null</code>.
     */
   public ForkerException(String message, String location) {
        super(message);
        this.location = location;
    }
     ...
     *                 occurred. Must not be <code>null</code>.
     */
  /*  public ForkerException(Throwable cause, Location location) {
        this(cause);
        this.location = location;
    }
  */
